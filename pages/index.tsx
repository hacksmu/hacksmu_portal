      ...
      <>
        ...
        <section className="bg-contain bg-hero-pattern">
          <div className="hero-content">
            <h1 className="pixel-neon-title text-center">HackSMU VII</h1>
        ...
        <section id="about" className="about-section">
          ...
          <div className="stat-item">
              ...
              <div classNaglow-text neon-titleglow-text neon-titleme="stat-label">Hackers</div>
            </div>
            <div className="stat-item">
          ...
          <ul className="about-list">
            <li>A platform for entrepreneurs, designers, and developers to unlock their creativity and drive positive
              social impact.
            </li>
            <li>An opportunity to connect with like-minded individuals, network with companies, and advance your
              career.
            </li>
        ...
        {/* FAQ */}
        <section id="faq" className="bg-blue-400">
          <div className="mt-4"/>
        ...
        {/* RESOURCES */}
        <section id="resources" className="bg-dark-teal text-white py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-center mx-auto resources-title py-3">Info and Resources</h2>

            <div className="flex flex-col md:flex-row items-stretch justify-between gap-8">
              <div className="md:w-1/2 bg-teal p-8 rounded-xl shadow-neon">
                <p className="text-2xl mb-6">
                  HackSMU will take place fully in person on October 25-26th, 2025. The address is{' '}
                  <span className="font-bold text-blue-700">3140 Dyer St, Dallas, TX 75205.</span>
                </p>
                ...
                <div className="text-center md:text-left">
                  <Link href="/dashboard" passHref>
                    <a className="inline-block bg-gradient-to-r from-orange to-neon-blue text-white font-bold py-3 px-8 rounded-full text-xl hover:shadow-neon transition duration-300">
                      Dashboard
                    </a>
                  </Link>
                </div>
              ...
              <div className="md:w-1/2 bg-teal p-8 rounded-xl shadow-neon flex justify-center items-center">
                <Image
                    src="/assets2025/Dallas25.gif"
        ...
        <section id="sponsors" className="relative bg-dark-blue text-white py-16 overflow-hidden">
          <div
              ...
              style={{backgroundImage: "url('/assets2025/FrutigerAero.png')"}}
              aria-hidden
          />
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="bg-teal p-8 rounded-xl shadow-neon mb-8">
              <p className="text-xl mb-6">
                At HackSMU, our mission is to foster innovation, creativity, and collaboration among students. By
                sponsoring us, you&apos;ll not only support the next generation of tech leaders but also gain visibility
                within a vibrant and dynamic community. Join us in making a lasting impact and help us turn ideas into
                reality! Support Innovation. Empower Creativity. Inspire the Future.
              </p>
            </div>
            ...
            */}
            ...
            <div className="text-center mt-8">
              <a
                  ...
                  className="inline-block bg-gradient-to-r from-orange to-neon-blue text-white font-bold py-6 px-16 rounded-full text-3xl hover:shadow-neon transition duration-300"
              >
                Sponsor Us!
              </a>
            </div>
        ...
        <section className="bg-gray-100 px-6 py-8 md:text-base text-xs">
          ...
          <div className="my-2 relative">
            ...
            <div className="space-x-4">
              ...
              <a href="https://www.facebook.com/smuhackathon/" rel="noopener noreferrer" target="_blank"
                 aria-label="Facebook">
            ...
            {/* Text */}
            <div className="absolute bottom-0 right-0">© 2025 SMU Computer Science Club</div>
          </div>
