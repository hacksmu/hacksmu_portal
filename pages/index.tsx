  ...
  return (
    <>
      ...
      <div className="top-left-panel">
          <div style={{ padding: 8, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 0, overflow: 'visible' }}>
            <div className="powered-by-logos" style={{ display: 'flex', flexDirection: 'column', gap: 0, alignItems: 'center' }}>
              <img className="SponsorLogos" src="/sponsors/SponsorLogos.png" alt="Sponsor Logos" style={{ height: 400, width: 'auto', objectFit: 'contain' }} />
            </div>
          </div>
        </div>
